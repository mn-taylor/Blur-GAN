...
BETA1 = 0.5
OUTPUT_DIR = './gan_outputs/flow/1b_overfit_lin'
EPSILON = 0.02
...
def train_gan():
    ...
    generator = Gen1b(LATENT_DIM, BLUR_EMB_DIM).to(device)
    ...
    for epoch in range(EPOCHS):
        ...
        for imgs in dataloader:  # imgs: [batch, B, 1, 28, 28]
            ...
            selected_imgs = imgs[torch.arange(imgs.size(0)), t_noisy]
